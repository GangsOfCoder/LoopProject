...
import com.app.base.cryptography.SharedPreferencesEncryption
import com.app.base.utils.Constants.PERMISSION_READ_EXTERNAL_STORAGE
...
object Utils {
    ...
    fun checkPermission(context: androidx.fragment.app.Fragment): Boolean {
        val currentAPIVersion = Build.VERSION.SDK_INT
        if (currentAPIVersion >= android.os.Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(context.requireContext(), Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
    ...
    * */
    @Synchronized
    fun getOriginalImagePath(fragmentActivity: androidx.fragment.app.FragmentActivity): String {
